...
test<-t(rbind("BOOTSTAP 341		", spearman, "				(2) PAGERANK: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- c (30, 24, 6, 9, 35, 21, 31, 5, 29, 3)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 341		", spearman, "				(2) PAGERANK: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1235		", spearman, "				(2) PAGERANK: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- c (19, 18, 11, 5, 22, 26, 30, 2, 7, 3)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1235		", spearman, "				(2) PAGERANK: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 931		", spearman, "				(2) PAGERANK: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- c (28, 24, 25, 26, 17, 34, 14, 21, 13, 9)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 931		", spearman, "				(2) PAGERANK: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1602		", spearman, "				(2) PAGERANK: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- c (20, 3, 5, 6, 4, 19, 17, 23, 28, 21)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1602		", spearman, "				(2) PAGERANK: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1997		", spearman, "				(2) PAGERANK: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- c (2, 19, 3, 20, 21, 23, 24, 5, 22, 10)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1997		", spearman, "				(2) PAGERANK: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
