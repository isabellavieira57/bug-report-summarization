...
test<-t(rbind("BOOTSTAP 341		", spearman, "				(3) LOUVAIN + CENTRALIDADE: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 341		", spearman, "				(3) LOUVAIN + CENTRALIDADE: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1235		", spearman, "				(3) LOUVAIN + CENTRALIDADE: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1235		", spearman, "				(3) LOUVAIN + CENTRALIDADE: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 931		", spearman, "				(3) LOUVAIN + CENTRALIDADE: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 931		", spearman, "				(3) LOUVAIN + CENTRALIDADE: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1602		", spearman, "				(3) LOUVAIN + CENTRALIDADE: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1602		", spearman, "				(3) LOUVAIN + CENTRALIDADE: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1997		", spearman, "				(3) LOUVAIN + CENTRALIDADE: ORIGINAL"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
...
oraculo <- head(oraculo, numLinhas)
spearman <- cor(oraculo, rankingAlgoritmo, method="spearman")
test<-t(rbind("BOOTSTAP 1997		", spearman, "				(3) LOUVAIN + CENTRALIDADE: TRANSFORMADA"))
write(test, file="resultados/resultadosMetricas/Resultados_spearman.txt", ncolumns = 5, append=TRUE)
